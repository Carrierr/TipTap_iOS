...
open class ScratchUIView: UIView, ScratchViewDelegate {
    ...
    public init(frame: CGRect, Coupon: UIImage, MaskImage: String, ScratchWidth: CGFloat) {
        super.init(frame: frame)
        backgroundImage = Coupon
        maskPath = MaskImage
    ...
    fileprivate func Init() {
        ...
        scratchView = ScratchView(frame: self.frame, CouponImage: backgroundImage, ScratchWidth: uiScratchWidth)
