...
//        postButton10?.setImage(UIImage(named: "post10"), for: .normal)
    ...
    private func setLabel(){
        ...
        postLabel1?.font  = UIFont.montserratBold(fontSize: 10)
        postLabel2?.font  = UIFont.montserratBold(fontSize: 10)
        postLabel3?.font  = UIFont.montserratBold(fontSize: 10)
        postLabel4?.font  = UIFont.montserratBold(fontSize: 10)
        postLabel5?.font  = UIFont.montserratBold(fontSize: 10)
        postLabel6?.font  = UIFont.montserratBold(fontSize: 10)
        postLabel7?.font  = UIFont.montserratBold(fontSize: 10)
        postLabel8?.font  = UIFont.montserratBold(fontSize: 10)
        postLabel9?.font  = UIFont.montserratBold(fontSize: 10)
        postLabel10?.font = UIFont.montserratBold(fontSize: 10)
